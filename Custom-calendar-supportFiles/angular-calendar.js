...
import { validateEvents, getMonthView, getWeekViewHeader, getWeekView, getDayView, getDayViewHourGrid, getResourceDayView, checkResource } from 'calendar-utils';
...
var CalendarUtils = /** @class */ (function () {
     ...
     */
    function (args) {
        if(args.resourceView){
          return getResourceDayView(args);
        }else{
...
var CalendarDayViewComponent = /** @class */ (function () {
     ...
     * @return {?}
     */
    function (dropEvent, segment, resourceId) {
        if (dropEvent.dropData && dropEvent.dropData.event) {
            if(this.hoveredSegment && this.hoveredSegment.date != segment.date){
                segment = this.hoveredSegment;
            }
            var dayEvent = dropEvent.dropData;
            var duration = (dayEvent.event.end - dayEvent.event.start) / (60 * 1000);
            var newEnd = addMinutes(segment.date, duration);
            this.eventTimesChanged.emit({
                event: dropEvent.dropData.event,
                newStart: segment.date,
                newEnd:newEnd,
                draggedObj:dropEvent.dropData,
     ...
     * @return {?}
     */
    function (dayEvent, draggedInPixels, resourceContainer) {
        var resourceDragged;
        
        var /** @type {?} */ pixelAmountInMinutes = MINUTES_IN_HOUR / (this.hourSegments * this.hourSegmentHeight);
        var /** @type {?} */ minutesMoved = draggedInPixels.y * pixelAmountInMinutes;
        var /** @type {?} */ newStart = addMinutes(dayEvent.event.start, minutesMoved);
        var /** @type {?} */ newEnd;
        if (dayEvent.event.end) {
            if(draggedInPixels.x){
                var args={event:dayEvent,draggedInPixels:draggedInPixels,resources:this.resources,reourceContainer:resourceContainer}
                var newResourceId = checkResource(args);
                this.resources.filter(function(resource){
                        if(resource.id == dayEvent.resourceId && dayEvent.resourceId != newResourceId){
                            var eventIndex = resource.events.indexOf(dayEvent.event);
                            if(eventIndex != -1){
                                resource.events.splice(eventIndex,1);
                            }
                        }
                        if(resource.id == newResourceId && dayEvent.resourceId != newResourceId){
                            resource.events.push(dayEvent.event);
                        }    
                });
            }
            newEnd = addMinutes(dayEvent.event.end, minutesMoved);
        }
        this.eventTimesChanged.emit({ newStart: newStart, newEnd: newEnd, event: dayEvent.event, resourceId: dayEvent.resourceId });
    };
    ...
    function () {
        if(this.resources && this.resources.length){
            this.actualWidth = 100 / this.resources.length+"%";
        }
        if(this.resourceWidth){
            this.actualWidth = this.resourceWidth+"px";
        }
        this.actualWidth;
        this.view = this.utils.getDayView({
            ...
            resourceWidth:this.resourceWidth
        });
        this.emitBeforeViewRender();
    };
    /**
    ...
    CalendarDayViewComponent.decorators = [
        { type: Component, args: [{
                    ...
                    template: "<div class=\"cal-day-view custom\" #dayViewContainer>\r\n  <div class=\"resource fixedHeader\">\r\n    <div *ngFor=\"let resource of view; trackBy:trackByindex\" class=\"resourceContainer\" #resourceHeader [ngStyle]=\"{\'width\': actualWidth}\">\r\n        <mwl-calendar-resource \r\n            [resource]=\"resource\"\r\n            [customTemplate]=\"resourceViewTemplate\"\r\n            (eventClicked)=\"eventClicked.emit({resource: resource})\">\r\n        </mwl-calendar-resource>\r\n    </div> \r\n  </div>    \r\n  <div class=\"resource resourceWrapper\" *ngIf=\"resourceView\" #resourceWrapper >\r\n        <div *ngFor=\"let resource of view; trackBy:trackByindex\" #resourceContainer class=\"resourceContainer\" [ngStyle]=\"{\'width\': actualWidth}\">\r\n          <mwl-calendar-resource *ngIf=\"false\"\r\n            [resource]=\"resource\"\r\n            [customTemplate]=\"resourceViewTemplate\"\r\n            (eventClicked)=\"eventClicked.emit({event: event})\">\r\n          </mwl-calendar-resource>\r\n        <mwl-calendar-all-day-event\r\n        *ngFor=\"let event of resource?.allDayEvents; trackBy:trackByEventId\"\r\n        [event]=\"event\"\r\n        [customTemplate]=\"allDayEventTemplate\"\r\n        [eventTitleTemplate]=\"eventTitleTemplate\"\r\n        (eventClicked)=\"eventClicked.emit({event: event})\">\r\n      </mwl-calendar-all-day-event>\r\n      <div class=\"cal-events\">\r\n        {{view.events}}      \r\n        <div #event\r\n        *ngFor=\"let dayEvent of resource?.events; trackBy:trackByDayEvent\"\r\n        class=\"cal-event-container\"\r\n        [class.cal-draggable]=\"dayEvent.event.draggable\"\r\n        [class.cal-starts-within-day]=\"!dayEvent.startsBeforeDay\"\r\n        [class.cal-ends-within-day]=\"!dayEvent.endsAfterDay\"\r\n        [ngClass]=\"dayEvent.event.cssClass\"\r\n        mwlResizable\r\n        [resizeEdges]=\"{top: dayEvent.event?.resizable?.beforeStart, bottom: dayEvent.event?.resizable?.afterEnd}\"\r\n        [resizeSnapGrid]=\"{top: eventSnapSize, bottom: eventSnapSize}\"\r\n        [validateResize]=\"validateResize\"\r\n        (resizeStart)=\"resizeStarted(dayEvent, $event, dayViewContainer)\"\r\n        (resizing)=\"resizing(dayEvent, $event)\"\r\n        (resizeEnd)=\"resizeEnded(dayEvent)\"\r\n        mwlDraggable\r\n        [dragAxis]=\"{x: dayEvent.event.draggable, y: dayEvent.event.draggable \&\& currentResizes.size === 0}\"\r\n                [validateDrag]=\"validateDrag\"\r\n        (dragPointerDown)=\"dragStart(event, dayViewContainer)\"\r\n        (dragEnd)=\"eventDragged(dayEvent, $event,resourceContainer)\"\r\n        [style.marginTop.px]=\"dayEvent.top\"\r\n        [style.height.px]=\"dayEvent.height\"\r\n        mwlDroppable\r\n        [ngStyle]=\"dayEvent.style\">\r\n        <mwl-calendar-day-view-event\r\n          [dayEvent]=\"dayEvent\"\r\n          [tooltipPlacement]=\"tooltipPlacement\"\r\n          [tooltipTemplate]=\"tooltipTemplate\"\r\n          [tooltipAppendToBody]=\"tooltipAppendToBody\"\r\n          [customTemplate]=\"eventTemplate\"\r\n          [eventTitleTemplate]=\"eventTitleTemplate\"      \r\n          (eventClicked)=\"eventClicked.emit({event: dayEvent.event})\">\r\n        </mwl-calendar-day-view-event>\r\n      </div>\r\n    </div>\r\n      <div class=\"cal-hour-rows\">\r\n        <div class=\"cal-hour\" *ngFor=\"let hour of hours; trackBy:trackByHour\" [style.minWidth.px]=\"view?.width + 70\">\r\n          <mwl-calendar-day-view-hour-segment\r\n            *ngFor=\"let segment of hour.segments; trackBy:trackByHourSegment\"\r\n            [style.height.px]=\"hourSegmentHeight\"\r\n            [segment]=\"segment\"\r\n            [segmentHeight]=\"hourSegmentHeight\"\r\n            [locale]=\"locale\"\r\n            [customTemplate]=\"hourSegmentTemplate\"\r\n            (click)=\"hourSegmentClicked.emit({date: segment.date})\"\r\n            [class.cal-drag-over]=\"segment.dragOver\"\r\n             [ngClass]= \"resource.id\"\r\n            mwlDroppable\r\n            (dragEnter)=\"segment.dragOver = true;\"\r\n            (dragLeave)=\"segment.dragOver = false;\"\r\n            (drop)=\"segment.dragOver = false; eventDropped($event, segment,resource.id)\">\r\n          </mwl-calendar-day-view-hour-segment>\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n  <div *ngIf=\"!resourceView\">\r\n    <mwl-calendar-all-day-event\r\n    *ngFor=\"let event of view.allDayEvents; trackBy:trackByEventId\"\r\n    [event]=\"event\"\r\n    [customTemplate]=\"allDayEventTemplate\"\r\n    [eventTitleTemplate]=\"eventTitleTemplate\"\r\n    (eventClicked)=\"eventClicked.emit({event: event})\">\r\n  </mwl-calendar-all-day-event>\r\n  <div class=\"cal-hour-rows\">\r\n    <div class=\"cal-events\">\r\n      <div\r\n        #event\r\n        *ngFor=\"let dayEvent of view?.events; trackBy:trackByDayEvent\"\r\n        class=\"cal-event-container\"\r\n        [class.cal-draggable]=\"dayEvent.event.draggable\"\r\n        [class.cal-starts-within-day]=\"!dayEvent.startsBeforeDay\"\r\n        [class.cal-ends-within-day]=\"!dayEvent.endsAfterDay\"\r\n        [ngClass]=\"dayEvent.event.cssClass\"\r\n        mwlResizable\r\n        [resizeEdges]=\"{top: dayEvent.event?.resizable?.beforeStart, bottom: dayEvent.event?.resizable?.afterEnd}\"\r\n        [resizeSnapGrid]=\"{top: eventSnapSize, bottom: eventSnapSize}\"\r\n        [validateResize]=\"validateResize\"\r\n        (resizeStart)=\"resizeStarted(dayEvent, $event, dayViewContainer)\"\r\n        (resizing)=\"resizing(dayEvent, $event)\"\r\n        (resizeEnd)=\"resizeEnded(dayEvent)\"\r\n        mwlDraggable\r\n        [dragAxis]=\"{x: false, y: dayEvent.event.draggable \&\& currentResizes.size === 0}\"\r\n        [dragSnapGrid]=\"{y: eventSnapSize}\"\r\n        [validateDrag]=\"validateDrag\"\r\n        (dragPointerDown)=\"dragStart(event, dayViewContainer)\"\r\n        (dragEnd)=\"eventDragged(dayEvent, $event.y)\"\r\n        [style.marginTop.px]=\"dayEvent.top\"\r\n        [style.height.px]=\"dayEvent.height\"\r\n        [style.marginLeft.px]=\"dayEvent.left + 70\"\r\n        [style.width.px]=\"dayEvent.width - 1\">\r\n        <mwl-calendar-day-view-event\r\n          [dayEvent]=\"dayEvent\"\r\n          [tooltipPlacement]=\"tooltipPlacement\"\r\n          [tooltipTemplate]=\"tooltipTemplate\"\r\n          [tooltipAppendToBody]=\"tooltipAppendToBody\"\r\n          [customTemplate]=\"eventTemplate\"\r\n          [eventTitleTemplate]=\"eventTitleTemplate\"\r\n          (eventClicked)=\"eventClicked.emit({event: dayEvent.event})\">\r\n        </mwl-calendar-day-view-event>\r\n      </div>\r\n    </div>\r\n    <div class=\"cal-hour\" *ngFor=\"let hour of hours; trackBy:trackByHour\" [style.minWidth.px]=\"view?.width + 70\">\r\n      <mwl-calendar-day-view-hour-segment\r\n        *ngFor=\"let segment of hour.segments; trackBy:trackByHourSegment\"\r\n        [style.height.px]=\"hourSegmentHeight\"\r\n        [segment]=\"segment\"\r\n        [segmentHeight]=\"hourSegmentHeight\"\r\n        [locale]=\"locale\"\r\n        [customTemplate]=\"hourSegmentTemplate\"\r\n        (click)=\"hourSegmentClicked.emit({date: segment.date})\"\r\n        [class.cal-drag-over]=\"segment.dragOver\"\r\n        mwlDroppable\r\n        (dragEnter)=\"segment.dragOver = true\"\r\n        (dragLeave)=\"segment.dragOver = false\"\r\n        (drop)=\"segment.dragOver = false; eventDropped($event, segment)\">\r\n      </mwl-calendar-day-view-hour-segment>\r\n    </div>\r\n  </div>\r\n  </div>    \r\n</div>"
                },] },
    ];
    /** @nocollapse */
    ...
    CalendarDayViewComponent.propDecorators = {
        ...
        "events": [{ type: Input },],
        "hourSegments": [{ type: Input },],
        "resourceView":[{type: Input},],
        "resources":[{type:Input},],
        "resourceWidth":[{type:Input}],
        "hourSegmentHeight": [{ type: Input },],
        "dayStartHour": [{ type: Input },],
        "dayStartMinute": [{ type: Input },],
        "dayEndHour": [{ type: Input },],
        ...
        "resourceViewTemplate":[{ type: Input },],
...
var CalendarResourceViewComponent = /** @class */ (function () {
    function CalendarResourceViewComponent() {
        this.eventClicked = new EventEmitter();
    }
    CalendarResourceViewComponent.decorators = [
        { type: Component, args: [{
                    selector: 'mwl-calendar-resource',
                    template: "\n<ng-template\n      #defaultTemplate\n      let-resource=\"resource\"\n      let-eventClicked=\"eventClicked\">\n      <div (mwlClick)=\"eventClicked.emit()\" class=\"resourceTitle\">\n        {{resource.name}}\n      </div>\n</ng-template>\n<ng-template\n  [ngTemplateOutlet]=\"customTemplate || defaultTemplate\"\n  [ngTemplateOutletContext]=\"{\n    resource: resource,\n    eventClicked: eventClicked\n  }\">\n</ng-template>\n "
                },] },
    ];
    /** @nocollapse */
    CalendarResourceViewComponent.propDecorators = {
        "resource": [{ type: Input },],
        "customTemplate": [{ type: Input },],
        "eventClicked": [{ type: Output },]
    };
    return CalendarResourceViewComponent;
}());
